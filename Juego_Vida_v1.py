...
def control_key(key, pause, new_game_state, i_timer):
    ...
    return pause, new_game_state, i_timer
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            pause, new_game_state, i_timer = control_key(event.key, pause, new_game_state, i_timer)
